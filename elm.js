...
Elm.CatalogList.make = function (_elm) {
   ...
   var caption = function (title) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("caption")]),
      _U.list([A2($Html.h5,_U.list([$Html$Attributes.$class("text-center")]),_U.list([$Html.text(title)]))
   ...
   var thumbnail = function (item) {
      ...
      _U.list([A2($Html.img,_U.list([$Html$Attributes.src(item.image),$Html$Attributes.alt("image")]),_U.list([])),caption(item.title)]));
   };
   ...
   return _elm.CatalogList.values = {_op: _op,caption: caption,thumbnail: thumbnail,catalogList: catalogList};
};
...
Elm.Details.make = function (_elm) {
   ...
   _U.list([A2($Html.div,
           ...
           _U.list([A2($Html.img,_U.list([$Html$Attributes.src("manuk.jpg"),$Html$Attributes.alt("image")]),_U.list([]))]))
...
Elm.Main.make = function (_elm) {
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([$Utils.stylesheetLink("https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css")
              ,$Utils.stylesheetLink("main.css")
              ,A2($Html.h1,_U.list([]),_U.list([$Html.text("Catalog")]))
   ...
   var initialModel = {catalogList: _U.list([{id: 1,title: "Some component Title",image: "manuk.jpg"}
